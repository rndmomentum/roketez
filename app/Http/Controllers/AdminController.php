...
{   
    ...
    {   
        ...
        $count_payment_history = PaymentHistory::whereRaw("(created_at >= ? AND created_at <= ?)", ["2021-05-01 00:00:00", "2021-05-31 23:59:59"])->where('price', '200')->where('status', 'paid')->count();
